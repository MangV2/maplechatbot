"""LangGraph 에이전트 그래프: 라우터(LLM) → clarify | RAG | boss | orchestrator | character_sync."""
import logging
...
def build_graph() -> StateGraph:
    """StateGraph: START → router(LLM 분류) → (clarify|no_answer|rag|boss|orchestrator|character_sync) → END."""
